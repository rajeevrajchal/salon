    ...
    return (
        <View style={[
            ...
            <View>
                ...
                <Text style={[typography.subTitle,{paddingVertical:padding.sm}]}>{ facility.time } mins  </Text>
                <Rating
            ...
            <View style={{
                ...
                <Image
                    ...
                    resizeMode={"cover"}
                    source={{uri: 'https://cdn.pixabay.com/photo/2016/11/29/03/36/beautiful-1867093__480.jpg'}}
                />
            </View>
        </View>
    );
